...
<Columns cols={2}>
    ...
    <Card
    title="Deep Agents"
    icon="/langsmith/images/deep-agents-icon.png"
    href="/langsmith/trace-deep-agents" horizontal />
...
<Columns cols={2}>
    ...
    <Card
    title="DeepSeek"
    icon="/images/providers/deepseek-icon.svg"
    href="/langsmith/trace-deepseek" horizontal />

    <Card
    title="Mistral"
    icon="/images/providers/mistral-icon.svg"
    href="/langsmith/trace-with-mistral" horizontal />
